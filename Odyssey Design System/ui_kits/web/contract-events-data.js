...
(function () {
  ...
  D.contractEventTypes = [
    ...
    { key: 'PriceChanged', label: 'Term changed',        enumValue: 6,  icon: 'price_change',         color: 'oklch(0.76 0.14 320)', soft: 'oklch(0.76 0.14 320 / 0.16)', auto: 'the agreement was re-priced',           desc: 'What the agreement costs was renegotiated or re-set.' },
