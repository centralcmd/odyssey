...
(function () {
  ...
  D.contractEventTypes = [
    ...
    { key: 'TermChanged', label: 'Term changed',        enumValue: 6,  icon: 'price_change',         color: 'oklch(0.76 0.14 320)', soft: 'oklch(0.76 0.14 320 / 0.16)', auto: 'a term of the agreement was changed',    desc: 'A term of the agreement (a price, rate, date or clause) was set or changed.' },
  ...
  D.contractEventSeed = {
    ...
    'ct-fiber': [
      ...
      { id: 'cev-f2', contractId: 'ct-fiber', source: 'user', type: 'TermChanged', title: 'Monthly charge raised to $84', description: 'Annual CPI+3.9% uplift clause. No right to exit on the increase.', notes: null, occurredAt: '2026-02-01T00:00:00Z', createdByUserId: 'u-sam', createdAtUtc: '2026-02-04T08:12:00Z' },
