...
(() => {
  const base = '../..';
  for (const p of ["components.css","colors_and_type.css","ui_kits/web/kit.css","ui_kits/web/account.css","ui_kits/web/account-signals.css","ui_kits/web/admin.css","styles.css"]) {
