...
/// <summary>
/// What kind of thing happened to a property (issue #209 §4.2). The wire enum; its persistence mirror is
/// <c>Odyssey.Context.PropertyEventType</c> — identical names and ordinals, cast by ordinal, and a guard
/// test fails the build if the two drift. Which members a property may carry is
/// <see cref="PropertyEventTypeMatrix"/>.
/// </summary>
/// <remarks>
/// <para>
/// <b>Ordinals start at 100 and are a wire and persistence contract.</b> Property rows share the
/// <c>Events</c> table's <c>Type</c> column with <c>ContractEventType</c>, which stays below 100,
