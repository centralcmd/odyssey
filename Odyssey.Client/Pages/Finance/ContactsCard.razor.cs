...
public partial class ContactsCard
{
    ...
    /// </summary>
    /// <remarks>
    /// Keyed on the payload EXTENSION, never on the status alone: a 409 from any other cause is not
    /// this dialog's, and must keep falling through to the ordinary toast.
    /// </remarks>
    private bool ShowDeleteBlockers(ExistingContact contact, ApiClient.ApiResult result)
    {
