// Drop this file into the Blazor client (e.g. Odyssey.Client/Theme/OdysseyTheme.cs)
// then update OdysseyThemeProvider.razor:
//
...
public static class OdysseyTheme
{
    public static readonly MudTheme Theme = new()
    {
        ...
        // MudBlazor's Shadows.Elevation is a single array shared by both light and dark mode —
        // there is no separate ShadowsDark / ShadowsLight in the MudTheme API.
        // The stack below is tuned for dark surfaces (deep opacity + 1px inset white highlight).
        // In light mode those shadows are too heavy and the inset highlight reads as a faint
        // bright stroke on white cards. See handoff/README.md §3 "app.css supplement" for the
        // [data-theme='light'] .mud-elevation-* overrides that neutralise this.
        //
        // All 26 steps (0–25) are defined here so MudBlazor never falls back to its defaults.
        Shadows = new Shadow
        {
            Elevation = new[]
            {
